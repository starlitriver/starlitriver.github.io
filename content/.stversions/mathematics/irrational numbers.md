...
an irrational number is a real numner that cannot be expressed as the ratio of two integers.
...
as $a^{\frac{1}{b}}=\sqrt[b]{a}$, operations involving irrational numbers can be done by following the [rules of exponents](mathematics/exponents.md)
