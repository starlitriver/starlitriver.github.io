...
for example, $\log(1000)$ is $\log_{10}(1000)$ which is 3


## solving

solving for logarithms operations with logarithms can be done using the [exponent rules](mathematics/exponents.md); you can set new variables and use them to evaluate logarithms.
