...
$5k-4>0$ or $k-1>0$
$k>\frac{4}{5}$ or $k>1$
$5^x>\frac{4}{5}$ or $5^x>1$
$x>\log_5(\frac{4}{5})$ or $x>0$
...
$0\leq(4m+7)(4m-3)$
$4m+7\geq 0$ or $4m-3\geq 0$
$m\geq -\frac{7}{4}$ or $m\geq \frac{3}{4}$
$2^{2x}\geq -\frac{7}{4}$ or $2^{2x}\geq \frac{3}{4}$
...
$3k(k-4)+5(k-4)=0$
$k=-\frac{5}{3}$ or $k=4$
$2^{\dfrac{1}{4}x}=-\frac{5}{3}$ or $2^{\dfrac{1}{4}x}=4$
