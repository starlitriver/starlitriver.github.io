...
### 2 degree polynomial
also called a quadratic equation, the graph of which is called a parabola

a quadratic equation has a turning point, a point where the gradient is zero, and it is either the maximum or minimum point of the graph.
#### standard form
$f(x)=ax^2+bx+c$
where a b c are constants
#### vertex form
$f(x)=a(x-h)^2+k$
where a h k are constants and (h,k) is the turning point of the equation
#### product form
$𝑓(𝑥) = 𝑎(𝑥 − 𝑥_1)(𝑥 − 𝑥_2)$
where a x_1 x_2 are constants and the x values of the x-intercepts are x_1 and x_2

### 3 degree polynomial
also called a cubic equation (the graph of which is called a cubic graph so there isn't another fancy word to haunt you)

a cubic equation has an [inflection point](https://en.wikipedia.org/wiki/Inflection_point), which is the point at which the gradient changes sign (negative or positive)
#### standard form
$f(x)=ax^3+bx^2+cx+d$
where a b c d are constants
#### vertex form
$f(x)=a(x-h)^3+k$
where a h k are constants and (h,k) is the inflection point of the equation
#### product form
...
## determining the equation of a polynomial
