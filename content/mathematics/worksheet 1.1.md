...
3. simplify the following
	...
	2. $\dfrac{2x^2+3x-5}{x^2+x}\div \dfrac{2x^2+7x+5}{x^2+2x+1}$
	3. $\dfrac{x+2}{3x+5}\cdot \dfrac{6x+10}{x^2-4}\div \dfrac{8x}{4-2x}$
	4. $\dfrac{x^2-9}{4-x^2}\div \dfrac{3+2x-x^2}{x^2+x-6}$
	5. $\dfrac{2x^2+x-3}{x^2+2x}\div \dfrac{x^2-4x+3}{x^2}\div \dfrac{2x^2+3x}{x^2-x-6}$
