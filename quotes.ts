...
`Do not throw sodium chloride at people. That's a salt.`,
`Me: My cat's tail came off so I had to get him a new one. Friend: Where do you buy a new tail from? Me: A retail store.`,
`How often do I tell chemistry jokes? Periodically.`,
`A guy stopped me in the street the other day and asked why I was carrying a 3 metre long book. I said, "It's a long story."`,
`If I was a DJ, I would be DJ Enzyme, because I'm always breaking it down.`,
`I told the nurse I was bitten by a wolf. "Where?" she asked. "No. Just a regular wolf." I replied.`,
`Someone stole the "P" from the pirate. Was he mad? He was irate.`,
`My horse will only come out of its stable when it gets dark. It's becoming a nightmare.`,
`Before you criticize someone, walk a mile in their shoes. That way, when you do criticize them, you're a mile away, and you have their shoes.`,
`This morning I was walking down the street and was hit by a violin, then a clarinet, and then by a french horn! I think it was an orchestrated attack.`,
`What did the pepper say to the salt at Christmas time? Season's greetings!`,
`Why did the toilet paper roll down the hill? Because it wanted to get to the bottom.`,
`After Monday and Tuesday, even the calendar says WTF.`,
`A physicist and an economist are walking in a forest when they saw a bear. The economist immediately started running. The physicist says "We'll never run faster that the bear!" The economist replies "I can't, but I can run faster than you!"`,
`Ten plus ten is the same as eleven plus eleven. Ten plus ten is twenty, and eleven plus eleven is twenty two.`,
`What did one tectonic plate say when it bumped into the other? Sorry, my fault.`,
`A mobius strip walks into a bar and collapses on a stool with a sigh. The bartender asks, "What's wrong?" The mobius strip says: "Where do I even begin?"`,
`When the pirate turned 80, he said to you, aye matey!`,
`Time flies like an arrow. Fruit flies like a banana.`,
`One plant said to another plant, are you hungry? It replied, i could use a light snack.`,
`What dinosaur you can never hear going to the bathroom? Pterodactyl, because it has a silent pee.`,
`What's it called when you are taking a long time to pee and there are people waiting in line behind you? Peer pressure.`,
`What do vegetarian zombies like? Grains.`,
`Two goldfish are in a tank. One says to the other: can you drive this thing?`,
`Heisenberg and Schrödinger get pulled over for speeding. The officer asks Heisenberg, "Do you know how fast you were going?" Heisenberg replies, "No, but we know exactly where we are!" The confused officer says, "You were going 200 kilometres an hour!" Heisenberg throws his arms up and cries, "Great! Now we're lost!" The officer looks over 
the car and asks Schrödinger if the two men have anything in the trunk. "A cat," Schrödinger replies. The officer opens the trunk and yells, "Hey! This cat is dead." Schrödinger angrily replies, "Well, he is now!"`,
`If you truly want something, the world itself gives you a way.`,
